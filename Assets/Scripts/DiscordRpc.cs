...
public class DiscordRpc
{
    ...
    public static void Initialise(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId)
    {
        Callbacks = handlers;
        ...
        InitialiseInternal(applicationId, ref staticEventHandlers, autoRegister, optionalSteamId);
    }

    [DllImport("discord-rpc", EntryPoint = "Discord_Initialize", CallingConvention = CallingConvention.Cdecl)]
    static extern void InitialiseInternal(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId);
